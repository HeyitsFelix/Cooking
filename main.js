	...
	Game.Init=function()
	{
		...
		Game.goldenCookie.spawn=function()
		{
			...
			if ((Game.elderWrath==1 && Math.random()<0.33) || (Game.elderWrath==2 && Math.random()<0.66) || (Game.elderWrath==3))
			{
				...
				me.style.background='url(https://cdn.jsdelivr.net/gh/coderdojoindy/cookie-clicker@master/img/wrathCookie.png)';
			}
			else
			{
				Game.goldenCookie.wrath=0;
				me.style.background='url(https://cdn.jsdelivr.net/gh/coderdojoindy/cookie-clicker@master/img/goldCookie.png)';
			}
